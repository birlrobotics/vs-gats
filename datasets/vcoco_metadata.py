...
action_class_with_object = [a for a in action_classes if a not in action_no_obj]
roles = ['none', 'obj', 'instr']
action_roles = {'point': ['agent', 'instr'], 'walk': ['agent'], 'jump': ['agent', 'instr'], 'snowboard': ['agent', 'instr'], 'carry': ['agent', 'obj'], 'run': ['agent'], 'work_on_computer': ['agent', 'instr'], 'cut': ['agent', 'obj', 'instr'], 'sit': ['agent', 'instr'], 'eat': ['agent', 'obj', 'instr'], 'talk_on_phone': ['agent', 'instr'], 'smile': ['agent'], 'ski': ['agent', 'instr'], 'kick': ['agent', 'obj'], 'surf': ['agent', 'instr'], 'hit': ['agent', 'obj', 'instr'], 'read': ['agent', 'obj'], 'drink': ['agent', 'instr'], 'lay': ['agent', 'instr'], 'catch': ['agent', 'obj'], 'hold': ['agent', 'obj'], 'throw': ['agent', 'obj'], 'look': ['agent', 'obj'], 'ride': ['agent', 'instr'], 'skateboard': ['agent', 'instr'], 'stand': ['agent']}


action_with_obj_index = dict()
for a in action_class_with_object:
    action_with_obj_index[a] = action_class_with_object.index(a)
