...
class VCOCOeval(object):
  ...
  def _do_eval(self, data_const, detections_file, ovr_thresh=0.5):
  ...
  def _do_role_eval(self, data_const, vcocodb, detections_file, ovr_thresh=0.5, eval_type='scenario_1'):
